...
public class GenericTypeResolverDemo {
    ...
    public static void main(String[] args) throws NoSuchMethodException {
		...
		// ArrayList<E> 是 List 泛型参数类型的抽象，返回null
		// 具备 ParameterizedType 返回，否则 null
		displayReturnTypeGenericInfo(GenericTypeResolverDemo.class, List.class, "getListE");
	...
	public static <E> ArrayList<E> getListE() { // 泛型参数类型具体化
		return null;
	}
    ...
    private static void displayReturnTypeGenericInfo(Class<?> containingClass, Class<?> genericIfc, String methodName, Class... argumentTypes) throws NoSuchMethodException {
        ...
        // 返回泛型参数类型，比如：List<Object> -> Object,
		// 使用泛型变量时，返回null. List<E> -> null.
		// 常规类型不具备泛型参数类型,String -> String
