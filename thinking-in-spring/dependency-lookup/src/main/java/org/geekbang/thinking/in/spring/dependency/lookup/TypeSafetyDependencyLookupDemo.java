...
public class TypeSafetyDependencyLookupDemo {
	...
	public static Log log= LogFactory.getLog(TypeSafetyDependencyLookupDemo.class);
    ...
    private static void displayObjectProviderStreamOps(AnnotationConfigApplicationContext applicationContext) {
        ...
        printBeansException("displayObjectProviderStreamOps", () -> userObjectProvider.forEach(System.err::println));
    }
    ...
    private static void displayObjectFactoryGetObject(AnnotationConfigApplicationContext applicationContext) {
        ...
        printBeansException("displayObjectFactoryGetObject", () -> System.err.println(userObjectFactory.getObject()));
    }
