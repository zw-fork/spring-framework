...
public class TargetFilterDemo {
    ...
    public static void main(String[] args) throws ClassNotFoundException {
        String targetClassName = "org.geekbang.thinking.in.spring.aop.overview.staticproxy.EchoService";
        // 获取当前线程 ClassLoader
        ClassLoader classLoader = Thread.currentThread().getContextClassLoader();
        // 获取目标类
        Class<?> targetClass = classLoader.loadClass(targetClassName);
        // 方法定义：String echo(String message);
        // Spring 反射工具类。获取echo()方法
        ...
        ReflectionUtils.doWithMethods(targetClass,
				method -> System.out.println("仅抛出 NullPointerException 方法为：" + method),
				method -> {
